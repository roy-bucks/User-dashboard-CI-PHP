...
<body>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="admin">Test App</a>
    ...
    <div class="container2">
      <p>Manage Users</p>
      <a class="add_new" href="new_user">Addd new users</a>
      <table>
        <tr>
          <th>ID</th>
          <th>Name</th>
...
<?php   foreach(array_reverse($data) as $value){?>
          ...
          <td><a href="accounts/edit_profile/<?= $value['Id'] ?>">  Edit  |</a> <a href="accounts/remove/<?=$value['Id']?>" onclick= "return confirm('Are you sure?')">  Remove</a></td>
        </tr>
<?php   } ?>
      </table>
    </div>
